...
/**
	...
	This is simple a data structure, it does not contain logic on how to send the email.  An appropriate `ufront.mail.IMailer` must be used to send the message.
